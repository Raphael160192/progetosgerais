...
namespace Timesheet
{
    public class TimesheetBot : BotBase
    {
        public TimesheetBot(string url, string login, string senha)
            : base(url, login, senha)
        {
        }

        public override void ProcessarInformacoes(List<Record> records)
        {
        ...
        private void ProcessRecord(Record record)
        {
            ...
            wait.Until(d => servicoDropDown.Options.Count > 1);
            ...
            wait.Until(d => categoriaDropDown.Options.Count > 1);
            ...
            wait.Until(d => subcategoriaDropDown.Options.Count > 1);
